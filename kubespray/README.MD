Reffer the oficial documentation by: https://kubespray.io/#/
...
ansible-playbook -i /tmp/new_kubespray/kubespray/inventory/qacluster/testinventory.ini --become --become-user=root cluster.yml   --flush-cache  -c paramiko
